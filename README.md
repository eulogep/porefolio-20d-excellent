# 🔒 Portfolio Cybersécurité - Euloge Junior Mabiala
...
- 🎓 Modules éducatifs sur la sécurité
- 🕵️ Simulation de recherche de fuites

**Objectif:** Sensibiliser aux risques liés aux mots de passe faibles et promouvoir les bonnes pratiques de sécurité.
...
- 💰 Simulation prix et slippage
- 🔐 Signature sécurisée via MetaMask
- 📱 UI responsive et optimisée

**Technologies:** React 18, ethers.js, SDK Uniswap, Web3
...
- **OSINT** & Renseignement sur les menaces
- **Sécurité applicative** & Code review
...
- **🌐 Portfolio:** [Portfolio en ligne](https://your-portfolio-url.com)
...
Ce portfolio et l'ensemble des projets présentés ont ét�� **entièrement développés par Euloge Junior Mabiala** dans le cadre de sa formation en cybersécurité et de sa recherche d'alternance.
...
**Développé avec passion par Euloge Junior Mabiala** | Étudiant-Ingénieur en Cybersécurité
